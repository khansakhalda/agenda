...
@if($showCreateModal)
  <div class="fixed inset-0 z-[9998] flex items-center justify-center bg-black/40" wire:ignore.self
    @keydown.escape.window="$wire.closeCreateModal()" @click.self="$wire.closeCreateModal()">
      ...
      <div class="px-5 py-4 max-h-[75vh] overflow-y-auto">
        <form wire:submit.prevent="createEvent" class="space-y-4">
          ...
          <div x-data="{
            ...
            <div class="relative">
              <input type="text" x-model="query" @keydown.tab.prevent="acceptGhost()" @keydown.enter.prevent="enter()"
