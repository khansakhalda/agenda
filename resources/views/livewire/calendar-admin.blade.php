...
@endif
    ...
    }" class="fixed top-4 right-4 z-[9999]" aria-live="polite">
                ...
                <div class="mt-0.5">
                    ...
                    <template x-if="type==='error'">
                        <svg class="h-5 w-5 text-red-600" viewBox="0 0 24 24" fill="currentColor">
                            <path
                                d="M12 2a10 10 0 100 20 10 10 0 000-20zm.75 5.5v6.25h-1.5V7.5h1.5zm0 8.75v1.5h-1.5v-1.5h1.5z" />
                        </svg>
                    </template>
