...
<div class="mb-5">
  <div class="flex items-center justify-between gap-3">
    ...
    <div class="flex items-center gap-2">
      ...
      <button type="button" wire:click="openCreateModal" wire:loading.attr="disabled"
      ...
      <div x-data="{ open:false }" class="relative" x-cloak wire:ignore>
        ...
        <div x-show="open" x-transition.origin.top.right @click.outside="open=false"
          class="absolute right-0 mt-2 w-72 rounded-2xl bg-white shadow-lg ring-1 ring-black/5 z-[9999] overflow-hidden">
